...
Docker (other containerisation tools are available) is a technology for delivering applications. It is not a virtualisation technology. While both containers and VMs are ways of delivering an isolated environment in which to deliver an application, the way they approach this is fundamentally different.
...
If you're a user, then you probably don't care very much. You will interact with the software in the same way that you would normally. 

If you're a developer then you do care and should read on...
